...
import FRUploadTableHead from './FRUploadTableHead';
import { faceTrakkSelectors, getThumbnails, selectFaceTrakkLoading } from '../store/faceTrakkSlice';

function FRUploadTable() {
