...
function PlatformMentionsWidget(props) {
  const widgets = useSelector(selectWidgets);
  const { series, labels, uniqueVisitors } = widgets?.platformMentions;
  ...
  const chartOptions = {
    ...
    colors: ['#F39C12', '#1D9BF0', '#4867AA', '#FF0000'],
    labels,
    plotOptions: {
      pie: {
        customScale: 0.9,
...
export default memo(PlatformMentionsWidget);
